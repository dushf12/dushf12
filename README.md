...
- 🔹 [Super Mario AWS EKS](https://github.com/dushf12/supermario-aws-eks): EKS provisioning with Terraform & Helm
- 🔹 [Terraform AWS CI](https://github.com/dushf12/terraform-aws-ci): End-to-end CI/CD infrastructure
- 🔹 [Grafana Observability Stack](https://github.com/dushf12/grafana-observability-stack): Plug-and-play monitoring setup
- 🔹 [AWS Tag Enforcer](https://github.com/dushf12/aws-tag-enforcer): IAM & tagging automation with Python/Boto3

---

> _"Simplify the complex, automate the mundane, and build resilient systems that scale."_


<!--
**dushf12/dushf12** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
